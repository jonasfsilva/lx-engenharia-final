...
import { CleanHtmlPipe } from "../blog-items/clean-html.pipe"; // ajuste o path conforme a pasta real
...
@Component({
  ...
  styleUrls: ['./home.component.css'], // corrigido: era "styleUrl"
})
export class HomeComponent implements OnInit, OnDestroy {
  ...
  posts_url =
    "https://octopus-app-yiik3.ondigitalocean.app/lxengenharia/api/v1/posts/";
  posts: any[] = [];
  ...
  getPosts() {
    this.http.get(this.posts_url).subscribe(
      (response: any) => {
